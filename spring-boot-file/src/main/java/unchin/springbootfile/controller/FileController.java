package unchin.springbootfile.controller;
...
import unchin.springbootfile.entity.FileInfo;
...
public class FileController {
    ...
    @GetMapping("/files")
    public Map<String, FileInfo> files(Model model){
    ...
    public String fileUpload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        FileInfo fileInfo = new FileInfo().setFileName ( file.getOriginalFilename());
